...
AS (SELECT
    ...
    FROM nfl_offense_week_3)

SELECT*
FROM Row_Number_CTE
where DuplicateCount > 1;

-- remove row number greater than 1
-- Rows with a number greater than 1 are the duplicates and should be removed
...
ALTER TABLE nfl_offense_week_3
ADD nfl_conference nvarchar(255);

-- afc_north
/*Baltimore Ravens", "Cincinnati Bengals", "Cleveland Browns", "Pittsburgh Steelers*/

UPDATE nfl_offense_week_3 set nfl_conference = 'afc_north' where team = 'Baltimore Ravens';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_north' where team = 'Cleveland Browns';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_north' where team = 'Cincinnati Bengals';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_north' where team = 'Pittsburgh Steelers';

-- afc_east
/*
"Miami Dolphins", "Buffalo Bills", "New England Patriots", "New York Jets" 
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_east' where team = 'Miami Dolphins';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_east' where team = 'Buffalo Bills';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_east' where team = 'New England Patriots';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_east' where team = 'New York Jets';
...
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_west' where team = 'Denver Broncos';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_west' where team = 'Kansas City Chiefs';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_west' where team = 'Las Vegas Raiders';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_west' where team = 'Los Angeles Chargers';

-- afc_south
/*
 "Houston Texans", "Indianapolis Colts", "Jacksonville Jaguars", "Tennessee Titans"
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_south' where team = 'Houston Texans';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_south' where team = 'Indianapolis Colts';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_south' where team = 'Jacksonville Jaguars';
UPDATE nfl_offense_week_3 set nfl_conference = 'afc_south' where team = 'Tennessee Titans';
...
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_north' where team = 'Chicago Bears';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_north' where team = 'Detroit Lions';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_north' where team = 'Green Bay Packers';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_north' where team = 'Minnesota Vikings';

-- nfc_east
/*
 "Dallas Cowboys", "New York Giants", "Philadelphia Eagles", "Washington Commanders"
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_east' where team = 'Dallas Cowboys';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_east' where team = 'New York Giants';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_east' where team = 'Philadelphia Eagles';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_east' where team = 'Washington Commanders';

-- nfc_west
/*
 "Arizona Cardinals", "Los Angeles Rams", "San Francisco 49ers", "Seattle Seahawks"
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_west' where team = 'Arizona Cardinals';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_west' where team = 'Los Angeles Rams';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_west' where team = 'San Francisco 49ers';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_west' where team = 'Seattle Seahawks';
...
*/
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_south' where team = 'Atlanta Falcons';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_south' where team = 'Carolina Panthers';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_south' where team = 'New Orleans Saints';
UPDATE nfl_offense_week_3 set nfl_conference = 'nfc_south' where team = 'Tampa Bay Buccaneers';
...
-- Most_total_yards - Philadephia Eagles

SELECT team, MAX(total_yards) as Most_Total_yards
FROM
nfl_offense_week_3
GROUP BY team
ORDER BY Most_Total_yards DESC

-- Determine the team with the most 1st down completions among all the NFL teams
-- Most_1st_down_completions - Buffalo Bills

SELECT 
team, MAX([1st_downs]) as Most_1st_down_completions
FROM
nfl_offense_week_3
GROUP BY team
ORDER BY  Most_1st_down_completions DESC

-- Determine the team with the most yards per play among all the NFL teams
-- Most yards_per_play -- Baltimore Ravens

SELECT 
team, MAX(yards_per_play) as Most_yards_per_play
FROM
nfl_offense_week_3
GROUP BY team
ORDER BY  Most_yards_per_play DESC
...
-- nfl_conference used - nfc_west
-- max_passing_touchdows - Los Angeles Rams
...
DROP TABLE if exists PassCompletionPercentage_Week_3
Create Table PassCompletionPercentage_Week_3
(
   team nvarchar (255),
...
Insert into PassCompletionPercentage_Week_3
...
AS (
  ...
  FROM PassCompletionPercentage_Week_3
)
SELECT
...
DROP TABLE if exists Total_number_of_touchdowns_Week_3
Create Table Total_number_of_touchdowns_Week_3
(
   team nvarchar (255),
   nfl_conference nvarchar(255),
...
Insert into Total_number_of_touchdowns_Week_3
...
AS (
  ...
  FROM Total_number_of_touchdowns_Week_3
)
SELECT
